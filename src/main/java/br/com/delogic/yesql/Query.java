...
public class Query<T> implements InitializingBean {
     ...
     */
    public List<T> getList(QueryParameters queryParameters) {
     ...
     */
    public T getFirst(QueryParameters queryParameters) {
        if (returnType == null) {
     ...
     */
    String composeQuery(QueryParameters queryParameters) {
     ...
     * @return String with the query composed and ready for execution
     */
    String composeCount(QueryParameters queryParameters) {
